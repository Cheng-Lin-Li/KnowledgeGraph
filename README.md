...
|[Market Index Prediction](https://cheng-lin-li.github.io/Market-Trend-Prediction)| This is a final project of building knowledge graph. I and my teammate YuCheng Kuo leverage not only stock price information but also combine social media listening data to feed into a LSTM (Long Short Term Memory) machine learning model to predict the trend of next day and next 30 day of Dow Jones Industrial Average index . |[Project Repository](https://github.com/Cheng-Lin-Li/Market-Trend-Prediction)|
